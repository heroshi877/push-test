...
var import_dist, import_dist2, import_dist3, e, t, s, c, l, y, h;
...
var import_dist4, import_dist5, import_dist6, isObject, proxyStateMap, refSet, buildProxyFunction, defaultProxyFunction;
...
var import_dist7, import_dist8, import_dist9, o, T, a, _, r, R, c2, p, W, y2, V, D, H, B, M, K, L, E, O, m, z, j, J, q, k, F, N, d, te, I, se, G, $, Q, X, S, Y, C, ne, g, oe;
var init_dist = __esm({
  "node_modules/@walletconnect/modal-core/dist/index.js"() {
    ...
    se = { state: I, subscribe(e2) {
      ...
      return new Promise((t2) => {
        ...
        if (a.removeWalletConnectDeepLink(), p.setWalletConnectUri(e2?.uri), p.setChains(e2?.chains), T.reset("ConnectWallet"), s2 && n) I.open = true, t2();
        else {
          const i = setInterval(() => {
            const l2 = p.state;
...
//# sourceMappingURL=chunk-LQLTIX76.js.map

...
// node_modules/@uniswap/widgets/dist/validateTokens-15d7780a.js
...
function validate10(data) {
  ...
  if (errors === 0) {
    if (data && _typeof(data) == "object" && !Array.isArray(data)) {
      var missing0;
      if (data.tokens === void 0 && (missing0 = "tokens")) {
        validate10.errors = [{
          instancePath,
          schemaPath: "#/required",
          keyword: "required",
...
//# sourceMappingURL=validateTokens-15d7780a-SH4KHPPY.js.map

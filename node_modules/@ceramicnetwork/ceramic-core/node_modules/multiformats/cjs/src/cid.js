...
var createCID = multiformats => {
  ...
  class CID {
    ...
    constructor(buffer, byteOffset = 0, byteLength = buffer.byteLength) {
      const bytes$1 = buffer instanceof Uint8Array ? bytes.coerce(buffer) : new Uint8Array(buffer, byteOffset, byteLength);
      const [version, code, multihash] = decodeCID(bytes$1);
      Object.defineProperties(this, {
        byteOffset: property(bytes$1.byteOffset, {
          enumerable: false
        }),
        byteLength: property(bytes$1.byteLength, {
          enumerable: false
        }),

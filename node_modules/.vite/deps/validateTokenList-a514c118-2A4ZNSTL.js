...
// node_modules/@uniswap/widgets/dist/validateTokenList-a514c118.js
...
function validate15(data) {
  var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref$instancePath = _ref.instancePath, instancePath = _ref$instancePath === void 0 ? "" : _ref$instancePath;
  _ref.parentData;
...
function validate14(data) {
  var _ref2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref2$instancePath = _ref2.instancePath, instancePath = _ref2$instancePath === void 0 ? "" : _ref2$instancePath;
  _ref2.parentData;
  _ref2.parentDataProperty;
  var _ref2$rootData = _ref2.rootData, rootData = _ref2$rootData === void 0 ? data : _ref2$rootData;
  var vErrors = null;
  var errors = 0;
  var _errs0 = errors;
  var valid0 = false;
...
function validate13(data) {
  var _ref3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref3$instancePath = _ref3.instancePath, instancePath = _ref3$instancePath === void 0 ? "" : _ref3$instancePath;
  _ref3.parentData;
  _ref3.parentDataProperty;
  var _ref3$rootData = _ref3.rootData, rootData = _ref3$rootData === void 0 ? data : _ref3$rootData;
  var vErrors = null;
  var errors = 0;
  var _errs0 = errors;
  var valid0 = false;
...
function validate12(data) {
  var _ref4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref4$instancePath = _ref4.instancePath, instancePath = _ref4$instancePath === void 0 ? "" : _ref4$instancePath;
  _ref4.parentData;
  _ref4.parentDataProperty;
  var _ref4$rootData = _ref4.rootData, rootData = _ref4$rootData === void 0 ? data : _ref4$rootData;
  var vErrors = null;
  var errors = 0;
  if (errors === 0) {
    if (data && _typeof(data) == "object" && !Array.isArray(data)) {
...
function validate11(data) {
  var _ref5 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref5$instancePath = _ref5.instancePath, instancePath = _ref5$instancePath === void 0 ? "" : _ref5$instancePath;
  _ref5.parentData;
  _ref5.parentDataProperty;
  var _ref5$rootData = _ref5.rootData, rootData = _ref5$rootData === void 0 ? data : _ref5$rootData;
  var vErrors = null;
  var errors = 0;
  if (errors === 0) {
    if (data && _typeof(data) == "object" && !Array.isArray(data)) {
      var missing0;
      if (data.chainId === void 0 && (missing0 = "chainId") || data.address === void 0 && (missing0 = "address") || data.decimals === void 0 && (missing0 = "decimals") || data.name === void 0 && (missing0 = "name") || data.symbol === void 0 && (missing0 = "symbol")) {
        validate11.errors = [{
          instancePath,
          schemaPath: "#/required",
          keyword: "required",
...
function validate10(data) {
  var _ref6 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref6$instancePath = _ref6.instancePath, instancePath = _ref6$instancePath === void 0 ? "" : _ref6$instancePath;
  _ref6.parentData;
  _ref6.parentDataProperty;
  var _ref6$rootData = _ref6.rootData, rootData = _ref6$rootData === void 0 ? data : _ref6$rootData;
  var vErrors = null;
  var errors = 0;
  if (errors === 0) {
    if (data && _typeof(data) == "object" && !Array.isArray(data)) {
      var missing0;
      if (data.name === void 0 && (missing0 = "name") || data.timestamp === void 0 && (missing0 = "timestamp") || data.version === void 0 && (missing0 = "version") || data.tokens === void 0 && (missing0 = "tokens")) {
        validate10.errors = [{
          instancePath,
          schemaPath: "#/required",
          keyword: "required",
              ...
              if (data.version !== void 0) {
                ...
                if (errors === _errs7) {
                  if (data2 && _typeof(data2) == "object" && !Array.isArray(data2)) {
                    var missing1;
                    if (data2.major === void 0 && (missing1 = "major") || data2.minor === void 0 && (missing1 = "minor") || data2.patch === void 0 && (missing1 = "patch")) {
                      validate10.errors = [{
                                ...
                                for (var key5 in data12) {
                                  ...
                                  if (errors === _errs36) {
                                    if (data13 && _typeof(data13) == "object" && !Array.isArray(data13)) {
                                      var missing2 = void 0;
                                      if (data13.name === void 0 && (missing2 = "name") || data13.description === void 0 && (missing2 = "description")) {
                                        validate10.errors = [{
...
export {
  validate10 as default,
  validate
};
//# sourceMappingURL=validateTokenList-a514c118-2A4ZNSTL.js.map

...
var varints = require('varint');
var bytes = require('./bytes.js');
var cid = require('./cid.js');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var varints__default = /*#__PURE__*/_interopDefaultLegacy(varints);

const cache = new Map();
const varint = {
  decode: data => {
    const code = varints__default['default'].decode(data);
    return [code, varints__default['default'].decode.bytes];
  },
  encode: int => {
    if (cache.has(int)) return cache.get(int);
    const buff = Uint8Array.from(varints__default['default'].encode(int));
    cache.set(int, buff);
    return buff;
  }
};
...
const create = (table = []) => {
  ...
  multiformats.CID = cid(multiformats);
  return multiformats;
};

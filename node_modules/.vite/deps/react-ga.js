...
var OutboundLink = function(_Component) {
  ...
  function OutboundLink3() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(OutboundLink3)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(OutboundLink3, [{
    ...
    value: function render() {
      var _this$props2 = this.props, href = _this$props2.to, oldProps = _objectWithoutProperties(_this$props2, ["to"]);
...
var plugin = {
  ...
  execute: function execute(pluginName, action) {
    ...
    if ((arguments.length <= 2 ? 0 : arguments.length - 2) === 1) {
      payload = arguments.length <= 2 ? void 0 : arguments[2];
    } else {
      actionType = arguments.length <= 2 ? void 0 : arguments[2];
      payload = arguments.length <= 3 ? void 0 : arguments[3];
    }
    if (typeof ga2 === "function") {
...
var OutboundLink2 = OutboundLink;
var esm_default = _objectSpread3({}, core_exports, {
